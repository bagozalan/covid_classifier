...
def main():
    ...
    if st.button('Random Forest'):
        ...
        f1_score = f1_score(Y_test, model.predict(X_test), pos_label=1)
        ...
        st.write('RandomForest f1_score:', f1_score)
    ...
    if st.button('DecisionTreeClassifier'):
        ...
        st.write('DecisionTreeClassifier recall:', f1_score2)
    ...
    if st.button('BaggingClassifier'):
        ...
        st.write('DecisionTreeClassifier recall:', f1_score3)
